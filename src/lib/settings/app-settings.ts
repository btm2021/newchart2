...
export const defaultAppSettings: AppSettings = {
  ...
  defaultInterval: "15",
  monitorBatchSize: 30,
  monitorRefreshSeconds: 14_400,
  monitorExpireMinutes: 240,
...
export function normalizeAppSettings(value: unknown): AppSettings {
  ...
  return {
    ...
    monitorRefreshSeconds: clampNumber(source.monitorRefreshSeconds, 15, 14_400, defaultAppSettings.monitorRefreshSeconds),
